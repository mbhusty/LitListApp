...
export const FONTS = {
  ...
  h3: {fontFamily: 'bold', fontSize: SIZES.h3, lineHeight: 30},
  ...
  bold: {fontFamily: 'bold', fontSize: SIZES.body3, lineHeight: 20},
  road: {fontFamily: 'roadRegular', fontSize: SIZES.body3, lineHeight: 20},
}
